...
const initialState = {
  contacts: JSON.parse(getLocalStorageItem("contacts")) || [],
};
  ...
  switch (action.type) {
    case ADD_CONTACT: {
      ...
      if (!flag) {
        ...
        let updatedContacts = JSON.parse(getLocalStorageItem("contacts")) || [];
    ...
    case REMOVE_CONTACT: {
      let Contacts = JSON.parse(getLocalStorageItem("contacts"));
